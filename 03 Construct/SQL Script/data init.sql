...
insert  INTO  products(productName,specs,originalPrice,discountedPrice,discountedExpiredDate,pic1,pic2,pic3,pic4,origin,nw,storageCondition,remark,createDate,status)
 select  '小眼带鱼7' productName ,'5两' specs,'197' originalPrice,'¥179.00' discountedPrice,NULL discountedExpiredDate,'/GanXian/img/product01.jpg' pic1 ,'' pic2,''pic3,''pic4,'舟山' origin,'2000克' nw, '5度以下 ' storageCondition, '东海本地带鱼，每年入冬后小眼带鱼又肥又鲜，清蒸出油，入口即化，鲜美无比。带鱼的麟含有多种营养成分，千万不要刮掉哦。唯一的问题就是小眼带鱼因为肉质细嫩，出水后很容易破肚，这个我们也没法避免，所以介意的朋友请慎拍。往往大家也会把破肚作为衡量是否为正宗小眼带鱼的标准之一。
