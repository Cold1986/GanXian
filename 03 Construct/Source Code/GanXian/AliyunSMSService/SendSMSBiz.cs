...
namespace AliyunSMSService
{
    public static class SendSMSBiz
    {
        ...
        public static SendBatchSmsResponse sendBatchSms(String accessKeyId, String accessKeySecret)
        {
            IClientProfile profile = DefaultProfile.GetProfile("cn-hangzhou", accessKeyId, accessKeySecret);
            DefaultProfile.AddEndpoint("cn-hangzhou", "cn-hangzhou", product, domain);
        ...
        public static QuerySendDetailsResponse querySendDetails(String accessKeyId, String accessKeySecret, String bizId)
        {
